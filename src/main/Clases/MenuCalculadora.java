...
public class MenuCalculadora {
	...
	public void AbrirMenu() {
		...
		do {
			...
			// InputMismatchException para los datos que no coinciden con el tipo esperado por el programa
			} catch (InputMismatchException e) { 
				scanner.nextLine();		// limpio el buffer del scanner para que no procese el caracter invalidonuevamente en el siguiente intento
